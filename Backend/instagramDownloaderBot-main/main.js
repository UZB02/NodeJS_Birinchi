...
bot.on("message", async (msg) => {
  try {
    ...
    if (getVideaUrl) {
      const loadingMessage = await bot.sendMessage(chatId, "Biroz kuting...");
      setTimeout(async () => {
    ...
    } else if (msg.text.toLocaleLowerCase() === "assalomu aleykum") {
      await bot.sendMessage(chatId, "Va aleykum assalom");
    } else if (msg.text.toLocaleLowerCase() === "seni kim tuzgan") {
